...
Template Customization: Templates can't be changed directly, but you can easily make your own version! Just click edit, make your changes, and save it as your own template. You'll find it in your "My Templates" section later. Full guide here
...
SSH Tunnel	Local development	SSH port forwarding to port 18000
Finding Your Token
...
For serious use, we recommend connecting the OpenAI-compatible API (port 8000) to your preferred client — Open WebUI, SillyTavern, oterm, or any application that speaks the OpenAI API.
